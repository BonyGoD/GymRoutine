...
import dev.bonygod.gymroutine.workout.data.datasource.WorkoutSessionRemoteDataSourceImpl
import dev.bonygod.gymroutine.workout.data.repository.WorkoutLogRepositoryImpl
import dev.bonygod.gymroutine.workout.data.repository.WorkoutSessionRepositoryImpl
...
val appModule = module {
    ...
    // Evolution use cases
    factory { GetExerciseEvolutionsUseCase(get()) }
    factory { SeedEvolutionDataUseCase(get(), get()) }
    ...
    // Workout sessions data layer
    single<WorkoutSessionRemoteDataSource> { WorkoutSessionRemoteDataSourceImpl(get()) }
    single<WorkoutSessionRepository> { WorkoutSessionRepositoryImpl(get()) }

    // Workout sessions use cases
