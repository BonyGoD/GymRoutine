...
fun UserProfile(
    ...
    val navigateToDashboardState by userProfileViewModel.shouldNavigate.collectAsState()

    LaunchedEffect(navigateToDashboardState) {
        if (navigateToDashboardState) {
            navigateToDashboard()
            userProfileViewModel.resetNavigationFlag()
        }
    }
    ...
    Box(modifier = Modifier.fillMaxSize()) {
        Column(
            ...
            Text(
                stringResource(Res.string.user_profile_weight),
                fontSize = 30.sp,
            ...
            Text(
                stringResource(Res.string.user_profile_height),
                fontSize = 30.sp,
                fontWeight = FontWeight.Bold,
                color = CustomYellow
            )
            ...
            Spacer(modifier = Modifier.padding(10.dp))
            Text(
                stringResource(Res.string.user_profile_age),
                fontSize = 30.sp,
                fontWeight = FontWeight.Bold,
                color = CustomYellow
            )
